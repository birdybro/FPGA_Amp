...
openxc7-terminal-current-half-parallel-timing-pnr:
	$(PYTHON) scripts/run_openxc7.py --top half_parallel_terminal_current_pnr_harness --nextpnr $(NEXTPNR) --placer-heap-timingweight 20
