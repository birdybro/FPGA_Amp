...
def main() -> int:
    ...
    report = {
        ...
        "limitations": [
            ...
            "fixed transient outputs have a separate 24,576-output long-vector RTL equivalence report; that proof does not make the two rates equivalent to each other",
