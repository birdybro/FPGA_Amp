...
| Nexys Video clock-only open route/bitstream | constrained R4 100 MHz input; Yosys 0.66 + nextpnr XC7 `DEFAULT` + Project X-Ray | five-iteration legal route; 74 LUTX / 24 FFX / 6 CARRY4 / 2 BUFG / 2 MMCM; activity path 305.06 MHz vs correctly derived 49.152 MHz; 9,730,853-byte CRC-readable `.bit`, SHA-256 `941a8c07...e0ff656`; no programming/frequency/codec claim |
