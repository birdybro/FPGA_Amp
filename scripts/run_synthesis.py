...
def main() -> int:
    ...
    parser.add_argument(
        ...
        choices=(
            ...
            "stream_384khz_49mhz_late_select_pnr_harness",
    ...
    sources = {
        ...
        "master_volume_ramp": ["rtl/audio/master_volume_ramp.sv"],
        ...
        "i2c_read_register_master": ["rtl/io/i2c_read_register_master.sv"],
        "adau1761_codec_init": [
        ...
        "phono_audio_top_xc7": [
            ...
            "fpga/nexys_video/audio_serial_clock_master_xc7.sv",
            "fpga/nexys_video/phono_audio_top_xc7.sv",
        ],
        "audio_clock_synth_xc7_pnr_harness": [
            "fpga/nexys_video/audio_clock_synth_xc7.sv",
        ],
