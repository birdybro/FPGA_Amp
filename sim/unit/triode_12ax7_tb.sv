...
module triode_12ax7_tb;
    ...
    initial begin
        ...
        if (!$value$plusargs("VECTORS=%s", vector_path)) begin
            vector_path = "sim/vectors/generated/triode_random.txt";
        end
        ...
        // Consume and verify the human-readable header.
        ...
        $display("PASS: %0d bit-exact vectors, latency=8 clocks", vector_count);
        $finish;
    end
endmodule
