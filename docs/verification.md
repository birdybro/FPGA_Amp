...
| shared-codec LRCLK/startup guard | directed BCLK-domain Verilator test plus Yosys 0.66 XC7 OOC | one identical LRCLK for ADC/DAC; ADC data pass-through; DAC data zero through reset and two configured synchronizer edges; 1 estimated logic cell / 2 FF / 0 DSP/BRAM; zero warnings/problems |
| Nexys Video complete audio-top contract | mutation-tested static RTL/XDC verifier | all 18 LOC/IOSTANDARD pairs exact; active-low G4 reset, open-drain I2C, internal 3.072 MHz BCLK timing constraint, 384 kHz/1,024-clock profile, shared-LRCLK guard, and fail-closed startup release checked |
| Nexys Video complete audio-top synthesis/pack | Yosys 0.66 XC7 complete hierarchy plus nextpnr XC7A200T pack | zero structural problems; 16,688 estimated LC / 11,687 FF / 217 DSP / ten RAMB18 equivalents; pack 59,709 LUTX / 11,687 FFX / 4,192 CARRY4 / 217 DSP / eight RAMB18 + one RAMB36 / three BUFG / two MMCM / 18 pads; no hardware claim |
| Nexys Video complete audio-top route | static placer + router2 seed 1; explicit 100 MHz input/3.072 MHz internal BCLK constraints; experimental XC7 `DEFAULT` grade | legal zero-overuse route in 30 iterations; fabric 58.008 MHz vs 49.152 MHz, BCLK 116.809 MHz vs 3.072 MHz; 17.24 ns chord-saturation path (5.76 ns logic / 11.48 ns routing); not qualified -1 timing or hardware validation |
| Nexys Video complete audio bitstream | routed FASM; pinned Project X-Ray conversion repeated twice plus `bitread -C` | 20,230 frame records; byte-identical 9,730,825-byte `.bit`, SHA-256 `3ea5cea8...c286f23`; parser accepts 24,060 frames / 2,432,650 words; generated only, never programmed |
