...
| 8x interpolator/decimator synthesis | Yosys 0.66 XC7 out-of-context | interpolation 1,549 LC / 12 DSP; shared-center-MAC decimation 2,448 LC / 12 DSP; no Fmax claim |
| 384 kHz banked-terminal complete stream | 64 outputs / 512 circuit samples plus controlled synthesis | bit-exact Q8.24; zero converter/solver/deadline diagnostics; 127-clock solver; 17,693 LC / 207 DSP / 10 RAMB18 equivalents versus 18,280 / 206 / 10 at 768 kHz |
...
| half-clock complete-stream placement | A200T static and heap, Yosys 0.66 + nextpnr XC7 `DEFAULT` grade | unchanged 63,902 LUTX / 207 DSP pack; static 38.34 MHz vs 49.152 MHz (1.28x miss); reduced-netlist heap still fails decimator-FF legalization; no route/timing claim |
