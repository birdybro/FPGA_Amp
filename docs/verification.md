...
| raw-node prefetch plus serial KCL maximum | 64 outputs / 512 updates; Yosys 0.66; A200T static seeds 1--2 + router2 | bit-exact at 127 clocks with zero diagnostics; 15,220 LC / 8,855 FF / 207 DSP / 10 RAMB18 equivalents; 54,280 LUTX / 8,855 FFX / 3,979 CARRY4 / 207 DSP; legal routes at 61.072/51.080 MHz vs 49.152 MHz; seed-1 16.37 ns terminal-current/state path, seed-2 19.58 ns registered-node/tube path; experimental `DEFAULT`-grade closure, no qualified -1/bitstream/hardware claim |
