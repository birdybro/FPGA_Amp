...
- Added a selectable two-batch terminal-current engine that overlaps its first
  ...
  CARRY4 / 34 DSP and reaches 90.50 MHz at the default placement weight. A
  reproducible timing-weight-20 run closes the isolated 98.304 MHz constraint
  at 99.59 MHz. Whole-solver synthesis falls from 209 to 189 DSPs, but seed-1
  default-weight placement reaches only 25.02 MHz with 59,514 LUTX / 14,590 FFX
