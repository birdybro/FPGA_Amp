...
| 8x interpolator/decimator synthesis | Yosys 0.66 XC7 out-of-context | reset-masked circular-history interpolation 950 LC / 938 FF / 12 DSP; decimation 961 / 618 / 12; no Fmax claim |
| 384 kHz banked-terminal complete stream | 64 outputs / 512 circuit samples plus controlled synthesis | bit-exact Q8.24; zero converter/solver/deadline diagnostics; 127-clock solver; circular-resampler build 15,716 LC / 8,547 FF / 207 DSP / 10 RAMB18 equivalents versus 16,062 / 9,033 / 206 / 10 at 768 kHz |
| complete 384 kHz stream named-part placement | three-pin harness, Yosys 0.66 + nextpnr XC7 `DEFAULT` grade | A100T packs at 63,902 LUTX / 14,737 FFX / 4,071 CARRY4 / 207 DSP but heap placement does not legalize; A200T static placement legal at 34.40 MHz vs 98.304 MHz; routing skipped, not promoted |
| half-clock 384 kHz complete stream | 49.152 MHz fabric; 1,024 clocks/input; 64 outputs / 512 updates | bit-exact to the same fixed stream; zero converter/solver/deadline diagnostics; 127 of 128 clocks used |
| circular-decimator half-clock placement | A200T heap/static, Yosys 0.66 + nextpnr XC7 `DEFAULT` grade | 58,363 LUTX / 10,562 FFX / 4,099 CARRY4 / 207 DSP; heap legal for first time but only 22.79 MHz; static 38.38 MHz vs 49.152 MHz; routing skipped |
| half-clock placement hierarchy | placed-JSON analyzer with explicit resampler groups | decimator 8,397 LUTX / 4,791 FFX / 12 DSP over 244x143 coordinates; interpolator 5,193 / 2,910 / 12 over 244x139; KCL 19,609 / 2,920 / 72 over 190x185 |
| circular-decimator placement hierarchy | same analyzer on refreshed static placement | decimator 2,725 LUTX / 618 FFX / 12 DSP over 244x181 coordinates; interpolator 5,225 / 2,910 / 12 over 184x242; KCL 19,616 / 2,920 / 72 over 211x160 |
| circular-resampler half-clock placement | A200T static, Yosys 0.66 + nextpnr XC7 `DEFAULT` grade | 56,041 LUTX / 8,589 FFX / 4,116 CARRY4 / 207 DSP; 41.27 MHz vs 49.152 MHz; route is diagnostic, no closure claim |
| circular-resampler placement hierarchy | same analyzer on refreshed static placement | interpolator 2,806 LUTX / 937 FFX / 12 DSP over 234x45 coordinates; decimator 2,725 / 618 / 12 over 48x203; KCL 19,627 / 2,920 / 72 over 230x153 |
| circular-resampler half-clock route | A200T static placer + router2, Yosys 0.66 + nextpnr XC7 `DEFAULT` grade | legal route in 15 iterations; 48.482 MHz vs 49.152 MHz (1.38% miss); 20.626 ns state/voltage/tube-input path, 6.19 ns logic + 14.44 ns routing; FASM emitted, no bitstream/hardware claim |
| parallel/pipelined half-clock profile | same 64-output / 512-update fixed vector plus A200T static placement | bit-exact with zero diagnostics at 123 clocks; 17,161 LC / 15,046 FF / 242 DSP / 20 RAMB18 equivalents; 66,658 packed LUTX and only 39.62 MHz, routing skipped and profile rejected |
| prefetched/retimed half-clock profile | 1,024 BE + 1,024 rate-specific KCL vectors; 512 solver updates; 64 outputs / 512 stream updates; A200T route | exact KCL maximum sideband and stream at unchanged 127 clocks; 15,852 LC / 9,793 FF / 207 DSP / 10 RAMB18 equivalents; legal 24-iteration route at 47.07 MHz with 21.24 ns chord-preview/tube-pin path; slower than baseline and rejected |
| late tube-pin selector | 64 outputs / 512 updates; Yosys 0.66; A200T seeds 1--3 | bit-exact at 127 clocks; 15,645 LC / 8,589 FF / 207 DSP / 10 RAMB18 equivalents; seed-1 legal route 48.700 MHz with 20.53 ns KCL-maximum path; seed 2 legal at 45.051 MHz; seed 3 route bounded after iteration 2; still 0.92% short, no closure claim |
| late selector plus deep KCL maximum | same complete stream; A200T seed 1 | bit-exact at 127 clocks; 16,120 LC / 9,665 FF / 207 DSP / 10 RAMB18 equivalents; router iteration 1 retained 45,484 overused wires after roughly 12 minutes and run was bounded during iteration 2; rejected congestion result, not a legal-route Fmax |
| late selector plus serial KCL maximum | 1,024 BE + 1,024 384 kHz trapezoidal KCL vectors; 64 outputs / 512 updates; A200T seed 1 | exact correction at 11 clocks and maximum sideband eight clocks later; exact 127-clock stream; 15,208 LC / 8,657 FF / 207 DSP / 10 RAMB18 equivalents; legal 14-iteration route 47.567 MHz; 21.02 ns chord-node/tube path; not closed |
| raw-node prefetch plus serial KCL maximum | 64 outputs / 512 updates; Yosys 0.66; A200T static seeds 1--2 + router2 | bit-exact at 127 clocks with zero diagnostics; 15,220 LC / 8,855 FF / 207 DSP / 10 RAMB18 equivalents; 54,280 LUTX / 8,855 FFX / 3,979 CARRY4 / 207 DSP; legal routes at 61.072/51.080 MHz vs 49.152 MHz; seed-1 16.37 ns terminal-current/state path, seed-2 19.58 ns registered-node/tube path; experimental `DEFAULT`-grade closure, no qualified -1/hardware claim |
| selected A200T open bitstream | seed-1 routed FASM; pinned Project X-Ray `fasm2frames`/`xc7frames2bit`; repeated conversion + `bitread -C` | 20,230 frame records; reproducible 9,730,907-byte `.bit`, SHA-256 `98a53adf...2b9dcb` twice; parser validates 24,060 configuration frames / 2,432,650 words; generated only, hardware unprogrammed/unvalidated |
| 384 kHz fabric/I²S/SPI hierarchy | 64 adapter frames; 64 serial inputs / 44 observable DAC frames; control test; 15 SPI frames | bit-exact model/calibrated/serial values; FIFO high-water marks all one; 265-clock model-valid interval and 192-BCLK/3-sample frame-boundary latency; all control/SPI checks pass |
| 384 kHz complete pin hierarchy synthesis | Yosys 0.66 XC7 out-of-context | adapter 15,699 LC / 9,085 FF; SPI/I²S top 16,614 LC / 11,586 FF; both 217 DSP / 10 RAMB18 equivalents and zero structural-check problems; no board timing/CDC/hardware claim |
| Nexys Video exact audio-clock plan | rational Python check parsed from XC7 RTL | exact 12.288 MHz MCLK, 49.152 MHz fabric, 960/614.4 MHz VCOs, and 128 clocks per 384 kHz sample; parameter-drift rejection tested |
| Nexys Video clock-only open route/bitstream | constrained R4 100 MHz input plus checked active-low G4 `CPU_RESETN`; Yosys 0.66 + nextpnr XC7 `DEFAULT` + Project X-Ray | three-iteration legal route; 99 LUTX / 24 FFX / 6 CARRY4 / 2 BUFG / 2 MMCM; activity path 291.55 MHz vs correctly derived 49.152 MHz; 9,730,853-byte CRC-readable `.bit`, SHA-256 `1d7d934f...234b248`; supersedes wrong-polarity `941a8c07...e0ff656`; no programming/frequency/codec claim |
| open-drain I2C register writer | bus-level Verilator target plus Yosys 0.66 XC7 OOC | exact address/register/data bytes; ACK, NACK, next-write recovery pass; 43 estimated logic cells / 59 FF / 3 CARRY4 / 0 DSP / 0 BRAM; no readback/arbitration claim |
| ADAU1761 fixed startup | bus-level Verilator target, 27-entry independent expectation table, forced NACK at index 5; Yosys 0.66 XC7 OOC | all 27 address/register/data writes exact; line mutes precede routing and two unmutes are last; NACK stops after transaction 6 and exposes index 5; 88 estimated logic cells / 94 FF / 10 CARRY4 / 0 DSP / 0 BRAM; no physical ACK/audio claim |
| audio BCLK/reset leaf | exact /16 divider, three-stage fabric/BCLK reset release, async reassertion | warning-free RTL pass; Yosys 10 FDCE / 1 CARRY4 / 1 BUFG, zero warnings/problems; full board timing pending |
| shared-codec LRCLK/startup guard | directed BCLK-domain Verilator test plus Yosys 0.66 XC7 OOC | one identical LRCLK for ADC/DAC; ADC data pass-through; DAC data zero and serial transport reset held through two configured synchronizer edges; 1 estimated logic cell / 2 FF / 0 DSP/BRAM; zero warnings/problems |
| Nexys Video complete audio-top contract | mutation-tested static RTL/XDC verifier | all 18 LOC/IOSTANDARD pairs exact; active-low G4 reset, open-drain I2C, internal 3.072 MHz BCLK timing constraint, 384 kHz/1,024-clock profile, shared-LRCLK guard, pre-configuration-frame exclusion, and fail-closed startup release checked |
| Nexys Video complete audio-top synthesis/pack | Yosys 0.66 XC7 complete hierarchy plus nextpnr XC7A200T pack | zero structural problems; 16,688 estimated LC / 11,687 FF / 217 DSP / ten RAMB18 equivalents; pack 59,710 LUTX / 11,687 FFX / 4,192 CARRY4 / 217 DSP / eight RAMB18 + one RAMB36 / three BUFG / two MMCM / 18 pads; no hardware claim |
| Nexys Video complete audio-top route | static placer + router2 seed 1; explicit 100 MHz input/3.072 MHz internal BCLK constraints; experimental XC7 `DEFAULT` grade | legal zero-overuse route in 20 iterations; fabric 54.663 MHz vs 49.152 MHz, BCLK 123.457 MHz vs 3.072 MHz; 18.29 ns prefetched-node/tube path (6.45 ns logic / 11.85 ns routing); not qualified -1 timing or hardware validation |
| Nexys Video complete audio bitstream | routed FASM; pinned Project X-Ray conversion repeated twice plus `bitread -C` | 20,230 frame records; byte-identical 9,730,825-byte `.bit`, SHA-256 `5f196e52...b09dbb8`; parser accepts 24,060 frames / 2,432,650 words; supersedes unprogrammed pre-transport-reset `3ea5cea8...c286f23`; generated only, never programmed |
| Nexys Video hardware preflight | exact `.bit` plus adjacent manifest; openFPGALoader/tool/USB discovery on 2026-08-15 | part, 9,730,825-byte length, SHA-256, CRC flag, 24,060 frames, and 2,432,650 words accepted; programmer unavailable and no board detected; no configuration performed and no hardware behavior claimed |
...
| decoupled-diagnostic wide KCL RTL/open route | 1,024 vectors per integration mode plus named-part route | correction bit-exact at latency 16, exact maximum sideband two clocks later; 87.07 MHz legal route at default weight, 80.03 MHz placement at weight 20; 29,569 LUTX / 10,437 FFX / 1,814 CARRY4 / 72 DSP (`DEFAULT` grade) |
| shared-capacitor decoupled KCL RTL/placement | 1,024 vectors per integration mode plus deterministic seed-1 placement | bit-exact at latency 16 with exact maximum sideband; 6,422 LC / 63 DSP; 29,469 LUTX / 10,437 FFX / 1,783 CARRY4; 72.95 MHz placement, routing skipped (`DEFAULT` grade) |
...
| parallel/decoupled-diagnostic terminal solver RTL/placement | 512 sequential samples plus both KCL integration modes and deterministic seed-1 placement | every state/diagnostic bit-exact, latency 123 clocks; 14,811 LC / 13,459 FF / 209 DSP; 59,188 packed LUTX and 31.97 MHz placement, so routing is skipped |
| shared-capacitor decoupled terminal solver RTL/placement | 512 stateful vectors and seed-1 placements | every state/diagnostic bit-exact at 123 clocks; 14,779 LC / 13,459 FF / 200 DSP / 20 RAMB18 equivalents; 58,885 LUTX; 35.06 MHz default and 29.05 MHz weight-20 placement, routing skipped |
| shared-capacitor plus shared-terminal solver RTL/placement | 512 stateful vectors, default and hierarchy-region placements | every state/diagnostic bit-exact at 124 clocks; 14,975 LC / 14,591 FF / 180 DSP / 20 RAMB18 equivalents; 30.63 MHz default and 32.94 MHz region/weight-20 placement, routing skipped |
...
| shared-terminal complete solver RTL/placement | 512 stateful vectors, deterministic three-pin harness, seed 1 | every state/diagnostic bit-exact at 127 clocks; 15,072 LC / 14,590 FF / 189 DSP / 20 RAMB18 equivalents; 25.02 MHz default-weight and 32.56 MHz tagged weight-20 placement, so candidate is not promoted |
| shared-terminal hierarchy-region placement | validated nextpnr pre-place hook, seed 1, timing weight 20 | 36,360 KCL/RHS and 25,574 nonlinear cells constrained to overlapping two-column regions; 36.83 MHz vs 98.304 MHz; placement-only evidence, routing skipped |
| soft-KCL synthesis/packing | asserted remap of exactly 11 KCL `$mul` cells; isolated and complete named-part pack | isolated 43,389 LC / 71,592 LUTX / 0 DSP; complete shared solver 51,475 LC / 101,479 LUTX / 117 DSP; pack legal, placement and Fmax explicitly not completed |
| capacitor-only soft-KCL mapping | asserted remap of exactly two 48x44 KCL `$mul` cells; seed-2 isolated placement and complete pack | isolated 12,710 LC / 36,327 LUTX / 54 DSP / 37.57 MHz placement; complete 21,333 LC / 66,341 LUTX / 171 DSP; routing and complete placement skipped |
| trapezoidal banked terminal stream | 64 outputs / 1,024 circuit samples plus synthesis | bit-exact, zero diagnostics, 127 clocks; current controlled build 18,280 LC / 206 DSP48E1 / 8 RAMB18E1 + 1 RAMB36E1; no Fmax claim |
...
| calibrated fabric mono adapter synthesis | Yosys 0.66 flattened structural | with output ramp: 18,642 LC / 16,354 FF / 216 DSP48E1 / 8 RAMB18E1 + 1 RAMB36E1; zero structural problems; no Fmax/CDC/stereo claim |
...
| pin-facing I²S mono top synthesis | Yosys 0.66 flattened structural | with output ramp, calibration guard, FIFO diagnostics, rate monitor: 19,156 LC / 17,669 FF / 216 DSP48E1 / 8 RAMB18E1 + 1 RAMB36E1; zero structural problems; no placed CDC/I/O/converter claim |
...
| SPI-controlled pin top synthesis | Yosys 0.66 flattened structural | 22-word multi-domain snapshot, timeout, fail-closed BCLK guard, and transport: 19,719 LC / 18,856 FF / 216 DSP48E1 / 8 RAMB18E1 + 1 RAMB36E1; zero structural problems; no placed SCLK/CDC/I/O/Fmax claim |
