...
// Four-stage 768 kHz to 48 kHz Q8.24 decimator. Each downstream stage is
// enabled by the preceding valid pulse, so no derived fabric clocks are used.
module decimator_16x (
    input  logic                 clk,
    input  logic                 rst_n,
    ...
    logic signed [31:0] stage4_sample;
    ...
    halfband_decimator_2x #(
        ...
        .ce_input,
        .sample_input_q24,
        .sample_output_q24(stage4_sample),
    ...
    halfband_decimator_2x #(
        ...
        .clk,
        .rst_n,
        .ce_input(stage4_valid),
        .sample_input_q24(stage4_sample),
