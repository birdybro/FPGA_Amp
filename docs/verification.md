...
| half-parallel terminal-current RTL/route | 1,027 directed/random vectors plus named-part harness | bit-exact; 34 DSP vs 54; 4,296 LUTX / 2,412 FFX / 334 CARRY4; 90.50 MHz vs 98.304 MHz (`DEFAULT` grade) |
